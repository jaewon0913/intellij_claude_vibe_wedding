...
export const invitationConfig: InvitationConfig = {
  ...
  invitationMessage: {
    title: "저희 결혼합니다",
    readmes: [
      "각자 다른 환경에서\n 각자의 branch에서 지내온 두 사람이\n어느 날 서로의 공통 code를 발견하고\n하나의 repository로\n함께 merge하기로 했습니다.",
      "막막한 날엔 서로에게 review를 부탁하고\n좋은 날엔 함께 log를 보며 웃으며\n서로의 든든한 pair로\n정성껏 commit 하겠습니다.",
      "이제 저희의 첫 정식 deploy를 앞두고\n귀한 걸음으로 함께해 주시면\n오래도록 감사한 마음으로 간직하겠습니다.",
    ],
    paragraphs: [
      "손을 잡고, 발을 맞춰",
  ...
  accounts: {
    groomSide: [
      { bank: "하나은행", accountNumber: "407-910888-23407", holder: "황재원" },
